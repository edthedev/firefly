...
Imports spider_2._0.Org.Mentalis.Utilities
...
Module Module2
    ...
    Public Function AdjustTokenDisk()
        WindowsController.EnableToken("SeManageVolumePrivilege")
        SMVN_priv = True
    End Function
    Public Function wipe_block(ByVal hdl As System.IntPtr, ByVal length As Long, ByVal startpos As Int64, ByVal method As WipeMethod)
